...
public class TightEnd extends Player implements Comparable<TightEnd>
{
	/*   TODO:
	...
	{
		TETotals weeklyTotals = new TETotals();
	...
	@Override
	public int compareTo(TightEnd o)
	{
		// TODO Auto-generated method stub
		return 0;
	}
}
class TETotals extends Totals
{
	...
	public TETotals(int currentRank, int receptions, double totalYards, double yardsPerAttempt, double yardsPerGame, 
